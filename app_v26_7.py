...
def _build_floating_battery_query_html(
    ...
    (() => {
      ...
      const preferenceKey = "ubike-battery-query-preferences-v5";
      ...
      page.innerHTML = `
        <header class="battery-header">
          ...
          <div class="battery-title">⚡ 2.0E 電量查詢｜v26.7</div>
        </header>
      ...
      function buildDisplayGroups(threshold, replacementResults) {
        ...
        const decorated = replacementResults
          .map(result => ({
            result,
