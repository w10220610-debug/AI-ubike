...
def render_app_hero() -> None:
    """以原創霓虹城市 SVG 建立首頁視覺；不依賴外部圖片檔。"""
    st.markdown(
        f"""
        <section class="dispatch-hero">
          <div class="dispatch-hero-copy">
            <div class="dispatch-kicker"><span class="dispatch-pulse-dot"></span>TAITUNG · NIGHT OPS NETWORK</div>
            <div class="dispatch-version-badge">{html.escape(APP_VERSION)}｜{html.escape(APP_VERSION_NAME)}</div>
            <h1>臺東 YouBike<br/><span>NEON DISPATCH</span></h1>
            <p>即時車況、電量情報、場站分析與 AI 路線，在夜色裡匯流成一座會呼吸的調度網路。</p>
            <div class="dispatch-hero-tags">
              <span>LIVE FLEET</span><span>BATTERY GRID</span><span>AI ROUTING</span>
            </div>
          </div>
          <div class="dispatch-hero-art" aria-hidden="true">
            <svg viewBox="0 0 430 210" role="img">
              <defs>
                <linearGradient id="heroSky" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#080a18"/><stop offset=".52" stop-color="#17113a"/><stop offset="1" stop-color="#071d2e"/></linearGradient>
                <linearGradient id="heroBattery" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#f6ff00"/><stop offset=".52" stop-color="#40f6ff"/><stop offset="1" stop-color="#ff3bd4"/></linearGradient>
                <linearGradient id="heroRoad" x1="0" y1="0" x2="1" y2="0"><stop stop-color="#40f6ff" stop-opacity="0"/><stop offset=".5" stop-color="#40f6ff"/><stop offset="1" stop-color="#ff3bd4" stop-opacity="0"/></linearGradient>
                <pattern id="heroGrid" width="22" height="22" patternUnits="userSpaceOnUse"><path d="M22 0H0V22" fill="none" stroke="#40f6ff" stroke-opacity=".13" stroke-width="1"/></pattern>
              ...
              <rect x="1" y="1" width="428" height="208" rx="24" fill="url(#heroSky)"/>
              <rect x="1" y="1" width="428" height="208" rx="24" fill="url(#heroGrid)"/>
              <circle cx="351" cy="44" r="31" fill="none" stroke="#ff3bd4" stroke-width="2" stroke-dasharray="7 6" opacity=".78" class="hero-orbit"/>
              <circle cx="351" cy="44" r="12" fill="#f6ff00" filter="url(#heroGlow)"/>
              <g class="hero-city" opacity=".92">
                <path d="M4 156H426V208H4Z" fill="#070b17"/>
                <path d="M12 156V118H42V156M48 156V93H78V156M84 156V126H108V156M114 156V76H151V156M157 156V108H185V156M192 156V87H224V156M230 156V119H257V156M264 156V68H304V156M310 156V103H343V156M350 156V82H389V156M395 156V126H420V156" fill="#0c1830" stroke="#40f6ff" stroke-opacity=".28"/>
                <g fill="#f6ff00" opacity=".8"><rect x="57" y="104" width="8" height="4"/><rect x="122" y="91" width="10" height="4"/><rect x="274" y="82" width="12" height="4"/><rect x="360" y="96" width="10" height="4"/></g>
                <g fill="#ff3bd4" opacity=".82"><rect x="18" y="130" width="12" height="4"/><rect x="166" y="122" width="9" height="4"/><rect x="204" y="102" width="10" height="4"/><rect x="402" y="137" width="9" height="4"/></g>
              </g>
              <path d="M12 178 C94 144 133 196 213 166 C291 137 330 181 422 145" fill="none" stroke="url(#heroRoad)" stroke-width="4" stroke-linecap="round" filter="url(#heroGlow)" class="hero-energy-road"/>
              <g transform="translate(164 38)" filter="url(#heroGlow)" class="hero-core">
                <rect x="0" y="0" width="90" height="118" rx="18" fill="#07111f" stroke="#40f6ff" stroke-width="3"/>
                <rect x="29" y="-8" width="32" height="12" rx="4" fill="#40f6ff"/>
                <path d="M51 18 26 67h24l-10 35 29-50H45Z" fill="url(#heroBattery)"/>
                <rect x="13" y="12" width="64" height="94" rx="11" fill="none" stroke="#ff3bd4" stroke-opacity=".55" stroke-dasharray="4 6"/>
              </g>
              <g class="hero-bike" transform="translate(286 143)">
                <circle cx="18" cy="29" r="15"/><circle cx="67" cy="29" r="15"/>
                <path d="M18 29 33 7l15 22H18M33 7h20l14 22M32 7l-6-12M22-5h17M48 29l13-17"/>
              </g>
              <g class="hero-data-nodes" fill="#40f6ff"><circle cx="70" cy="54" r="4"/><circle cx="99" cy="38" r="3"/><circle cx="318" cy="112" r="4"/><path d="M70 54 99 38M254 91l64 21" stroke="#40f6ff" stroke-width="2" stroke-dasharray="4 5"/></g>
            </svg>
            <div class="hero-art-label"><b>GRID 27</b><span>ENERGY LINK ONLINE</span></div>
          </div>
        </section>
        """,
        unsafe_allow_html=True,
        ...
        (() => {{
            ...
            style.textContent = `
                ...
                @media (max-width: 700px) {{
                    ...
                    #ubike-float-tools .uft-search {{ font-size: 20px; }}
                    #ubike-float-tools .uft-panel {{
                        right: -66px;
                        bottom: 58px;
                ...
                @media (max-width: 380px) and (max-height: 680px) {{
                    #ubike-float-tools {{ right: 74px; }}
                    #ubike-float-tools .uft-actions {{ gap: 5px; }}
                    #ubike-float-tools .uft-button {{
                        width: 46px;
                        height: 46px;
                        flex-basis: 46px;
                    }}
                    #ubike-float-tools .uft-panel {{ right: -62px; bottom: 55px; }}
                }}
            `;
...
st.markdown(
    ...
    /* v27.3：保留相容修正，並以 9:16 直式手機視窗為主要設計基準。 */
    :root {
        --cyber-bg: #050713;
        --cyber-panel: rgba(10, 15, 34, .88);
        --cyber-panel-strong: #0b1024;
        --cyber-cyan: #40f6ff;
        --cyber-magenta: #ff3bd4;
        --cyber-yellow: #f6ff00;
        --cyber-blue: #4c72ff;
        --cyber-text: #eefcff;
        --cyber-muted: #98afc4;
        --cyber-line: rgba(64, 246, 255, .28);
    }
    body {
    ...
    [data-testid="stAppViewContainer"] {
        color: var(--cyber-text);
        background:
            radial-gradient(circle at 14% 8%, rgba(255,59,212,.18), transparent 25rem),
            radial-gradient(circle at 88% 28%, rgba(64,246,255,.14), transparent 30rem),
            linear-gradient(145deg, #050713 0%, #090b1d 47%, #041421 100%) !important;
    }
    [data-testid="stMain"] {
    ...
    [data-testid="stHeader"] {background: rgba(5,7,19,.72) !important; backdrop-filter: blur(14px);}
    [data-testid="stToolbar"] {color: var(--cyber-text);}
    [data-testid="stSidebar"] {
        border-right: 1px solid rgba(64,246,255,.24);
        background:
            linear-gradient(180deg, rgba(18,10,38,.97), rgba(5,17,29,.98)) !important;
        box-shadow: 12px 0 38px rgba(0,0,0,.34);
    }
    [data-testid="stSidebar"]::before {
        ...
        letter-spacing: .22em;
        text-shadow: 0 0 12px rgba(64,246,255,.72);
    }
    [data-testid="stSidebar"] * {color: var(--cyber-text);}
    .block-container {
        position: relative;
        z-index: auto;
        visibility: visible !important;
    ...
    .stApp p, .stApp label, .stApp [data-testid="stCaptionContainer"] {color: var(--cyber-text);}
    .stApp h2, .stApp h3, .stApp h4 {
        letter-spacing: .015em;
        text-shadow: 0 0 16px rgba(64,246,255,.17);
    }
    .stApp h2::before, .stApp h3::before {
        content: "//";
        margin-right: .42rem;
        color: var(--cyber-magenta);
        font-family: ui-monospace, SFMono-Regular, Consolas, monospace;
    }
    .stApp hr {border-color: rgba(64,246,255,.17);}
    .stApp a {color: var(--cyber-cyan);}
    ...
    .dispatch-hero {
        ...
        border: 1px solid rgba(64,246,255,.55);
        border-radius: 28px 8px 28px 8px;
        background:
            linear-gradient(110deg, rgba(7,10,26,.96), rgba(25,11,48,.9) 52%, rgba(3,28,40,.94)),
            #080b1b;
        box-shadow:
            inset 0 0 0 1px rgba(255,59,212,.12),
            0 0 0 1px rgba(246,255,0,.05),
            0 20px 55px rgba(0,0,0,.42),
            0 0 36px rgba(64,246,255,.11);
    }
    .dispatch-hero::before {
        ...
        pointer-events: none;
        background:
            linear-gradient(90deg, transparent 0 49.7%, rgba(64,246,255,.14) 50%, transparent 50.3%),
            repeating-linear-gradient(0deg, transparent 0 8px, rgba(255,255,255,.018) 9px 10px);
    ...
    .dispatch-hero::after {
        ...
        right: -95px;
        top: -120px;
        border: 1px solid rgba(255,59,212,.38);
        background: radial-gradient(circle, rgba(255,59,212,.26), transparent 67%);
        box-shadow: 0 0 50px rgba(255,59,212,.16);
    }
    .dispatch-hero-copy {z-index: 2;}
    .dispatch-kicker {
        display: flex;
        align-items: center;
        gap: .5rem;
        ...
        font-size: .72rem;
        letter-spacing: .16em;
        text-shadow: 0 0 14px rgba(64,246,255,.75);
    }
    .dispatch-pulse-dot {
        width: 8px;
        height: 8px;
        ...
        box-shadow: 0 0 0 5px rgba(246,255,0,.09), 0 0 16px var(--cyber-yellow);
        animation: cyberPulse 1.2s ease-in-out infinite;
    }
    .dispatch-version-badge {
        border: 1px solid rgba(255,59,212,.52);
        border-radius: 4px 12px 4px 12px;
        color: #ffd6f7;
        background: rgba(255,59,212,.1);
        box-shadow: inset 0 0 18px rgba(255,59,212,.08), 0 0 14px rgba(255,59,212,.09);
        font-family: ui-monospace, SFMono-Regular, Consolas, monospace;
    ...
    .dispatch-hero h1 {
        ...
        text-shadow: 3px 3px 0 rgba(255,59,212,.24), -2px -1px 0 rgba(64,246,255,.22);
    }
    .dispatch-hero h1 span {
        color: transparent;
        background: linear-gradient(90deg, var(--cyber-yellow), var(--cyber-cyan) 52%, var(--cyber-magenta));
        background-clip: text;
        -webkit-background-clip: text;
        filter: drop-shadow(0 0 10px rgba(64,246,255,.25));
        font-size: .72em;
        letter-spacing: .07em;
    }
    .dispatch-hero p {color: #b9cad9; font-size: 1rem; line-height: 1.62;}
    .dispatch-hero-tags {display:flex; flex-wrap:wrap; gap:.42rem; margin-top:.9rem;}
    .dispatch-hero-tags span {
        padding: .28rem .54rem;
        border: 1px solid rgba(64,246,255,.32);
        border-radius: 3px;
        color: var(--cyber-cyan);
        background: rgba(64,246,255,.06);
        font: 850 .62rem/1 ui-monospace, SFMono-Regular, Consolas, monospace;
        letter-spacing: .09em;
    }
    .dispatch-hero-art {
        position: relative;
        ...
        overflow: hidden;
        box-shadow: 0 0 28px rgba(64,246,255,.1);
    }
    .dispatch-hero-art svg {display:block; min-height:205px;}
    .hero-art-label {
        position: absolute;
        left: 12px;
        right: 12px;
    ...
    .hero-art-label b {color:var(--cyber-yellow);}
    .hero-bike circle, .hero-bike path {stroke: var(--cyber-cyan); stroke-width:4; filter:drop-shadow(0 0 5px rgba(64,246,255,.65));}
    .hero-orbit {transform-origin:351px 44px; animation:heroOrbit 14s linear infinite;}
    .hero-energy-road {stroke-dasharray:12 9; animation:heroRoad 1.7s linear infinite;}
    .hero-core {animation:heroFloat 3.4s ease-in-out infinite;}

    .dispatch-context-strip {
        border: 1px solid rgba(64,246,255,.28);
        border-radius: 4px 16px 4px 16px;
        background: linear-gradient(90deg, rgba(8,17,35,.92), rgba(18,10,39,.88));
        box-shadow: inset 4px 0 var(--cyber-cyan), 0 10px 24px rgba(0,0,0,.24);
    }
    .dispatch-context-strip span {
        color: #dcefff;
        border: 1px solid rgba(64,246,255,.14);
        border-radius: 4px;
        background: rgba(64,246,255,.055);
    }
    .dispatch-context-strip b {color: var(--cyber-yellow);}
    [data-testid="stVerticalBlockBorderWrapper"] {
        border: 1px solid rgba(64,246,255,.24) !important;
        border-radius: 6px 18px 6px 18px !important;
        background: linear-gradient(135deg, rgba(8,15,33,.9), rgba(20,10,39,.78));
        box-shadow: 0 13px 30px rgba(0,0,0,.25), inset 0 0 24px rgba(64,246,255,.025);
    }
    div[data-testid="stExpander"] {
        border: 1px solid rgba(255,59,212,.24);
        border-radius: 5px 16px 5px 16px;
        background: rgba(8,13,30,.82);
    }
    div[data-testid="stExpander"] summary {color: var(--cyber-cyan);}
    [data-testid="stTabs"] [data-baseweb="tab-list"] {
        gap: .35rem;
        border-bottom-color: rgba(64,246,255,.18);
    }
    [data-testid="stTabs"] button[role="tab"] {color:#9db7ca;}
    [data-testid="stTabs"] button[aria-selected="true"] {color:var(--cyber-yellow); border-bottom-color:var(--cyber-magenta);}

    .stButton > button, .stDownloadButton > button, button[kind="primary"] {
        border: 1px solid rgba(64,246,255,.58) !important;
        border-radius: 4px 12px 4px 12px !important;
        color: #f7ffff !important;
        background: linear-gradient(110deg, rgba(28,55,91,.94), rgba(71,20,89,.94)) !important;
        box-shadow: inset 0 0 15px rgba(64,246,255,.08), 0 0 15px rgba(64,246,255,.1) !important;
    ...
    .stButton > button:hover, .stDownloadButton > button:hover {
        ...
        box-shadow: 0 0 22px rgba(246,255,0,.18), 0 8px 22px rgba(0,0,0,.28) !important;
    }
    div[data-baseweb="select"] > div,
    div[data-testid="stTextInput"] input,
    div[data-testid="stNumberInput"] input,
    div[data-testid="stTextArea"] textarea {
        border-color: rgba(64,246,255,.3) !important;
        color: var(--cyber-text) !important;
        background: rgba(5,12,28,.92) !important;
        box-shadow: inset 0 0 14px rgba(64,246,255,.035);
    }
    div[data-baseweb="select"] svg {fill: var(--cyber-cyan);}
    div[data-baseweb="popover"], [role="listbox"] {background:#0a1022 !important; color:var(--cyber-text) !important;}
    [role="option"]:hover {background:rgba(64,246,255,.12) !important;}
    [data-testid="stRadio"] label, [data-testid="stCheckbox"] label, [data-testid="stToggle"] label {color:var(--cyber-text);}
    [data-testid="stMetric"] {
        border: 1px solid rgba(64,246,255,.2);
        border-radius: 5px 14px 5px 14px;
        padding: .65rem .75rem;
        background: rgba(7,14,31,.82);
    }
    [data-testid="stMetricValue"] {color: var(--cyber-yellow); text-shadow:0 0 12px rgba(246,255,0,.2);}

    .region-fleet-overview {
        border-color: rgba(64,246,255,.22);
        border-radius: 5px 16px 5px 16px;
        background: rgba(7,14,31,.82);
        box-shadow: inset 3px 0 rgba(64,246,255,.55);
    }
    .region-fleet-metric {
        border-color: rgba(255,59,212,.18);
        background: linear-gradient(135deg, rgba(12,22,43,.94), rgba(27,12,43,.85));
    }
    .region-fleet-metric-head span {background:rgba(64,246,255,.09);}
    .fleet-summary-card {
        --fleet-soft: rgba(10,18,37,.96);
        --fleet-border: rgba(64,246,255,.3);
        border-radius: 7px 22px 7px 22px;
        background:
            radial-gradient(circle at 12% 20%, rgba(64,246,255,.08), transparent 34%),
            linear-gradient(135deg, rgba(8,17,35,.97), rgba(26,10,42,.94) 76%);
        box-shadow: 0 16px 34px rgba(0,0,0,.3), inset 0 0 24px rgba(64,246,255,.02);
    }
    .fleet-theme-ebike {--fleet-accent: var(--cyber-cyan); --fleet-border:rgba(64,246,255,.42);}
    .fleet-card-illustration {background:rgba(64,246,255,.075); border:1px solid rgba(64,246,255,.16);}
    .fleet-card-title, .fleet-metric-value {color:var(--cyber-text);}
    .fleet-theme-ebike .fleet-card-title {color:var(--cyber-cyan);}
    .fleet-card-subtitle, .fleet-metric-label {color:#9fb4c7;}
    .fleet-metric-block {border-left-color:rgba(64,246,255,.18);}
    .fleet-data-notice {
        border-color:rgba(246,255,0,.38);
        border-radius:5px 17px 5px 17px;
        background:linear-gradient(135deg, rgba(49,42,4,.88), rgba(12,17,31,.94));
        box-shadow:0 0 20px rgba(246,255,0,.07);
    }
    .fleet-notice-title {color:var(--cyber-yellow);}
    .fleet-notice-text {color:#e8e9ad;}
    .fleet-legend {color:#a8bacc;}

    .analysis-result-table {
        border-color: rgba(64,246,255,.3);
        border-radius: 5px 16px 5px 16px;
        background: #091022;
    ...
    .analysis-result-table th {
        color: var(--cyber-cyan);
        background: linear-gradient(90deg, #0b1830, #20102f);
        text-shadow:0 0 9px rgba(64,246,255,.35);
    }
    .analysis-result-table th, .analysis-result-table td {border-color:rgba(64,246,255,.13);}
    .analysis-result-table td {color:#eaf8ff; background:rgba(8,15,32,.9);}
    .analysis-zone-label {color:var(--cyber-yellow) !important;}
    .analysis-status-extra {background:rgba(255,59,100,.26) !important;}
    .analysis-status-short {background:rgba(255,151,40,.22) !important;}
    .analysis-status-error {background:rgba(246,255,0,.17) !important;}
    .analysis-status-ok {background:rgba(44,255,178,.15) !important;}

    @keyframes cyberPulse {0%,100%{opacity:.58; transform:scale(.85)}50%{opacity:1; transform:scale(1.18)}}
    @keyframes heroOrbit {to{transform:rotate(360deg)}}
    @keyframes heroRoad {to{stroke-dashoffset:-42}}
    @keyframes heroFloat {0%,100%{transform:translate(164px,38px)}50%{transform:translate(164px,32px)}}

    @media (max-width: 900px) {
        .dispatch-hero {
            grid-template-columns: minmax(0,1fr) minmax(132px,.55fr);
            min-height: 176px;
            padding: .9rem;
            border-radius: 18px 5px 18px 5px;
        }
        .dispatch-hero h1 {font-size:clamp(1.55rem,7vw,2.25rem);}
        .dispatch-hero p {font-size:.76rem; line-height:1.45;}
        .dispatch-hero-tags {gap:.25rem; margin-top:.55rem;}
        .dispatch-hero-tags span {padding:.2rem .34rem; font-size:.49rem;}
        .dispatch-hero-art {min-height:150px;}
        .dispatch-hero-art svg {min-height:150px; transform:scale(1.15);}
        .hero-art-label {font-size:.45rem;}
    }
    @media (max-width: 560px) {
        .dispatch-hero {grid-template-columns:minmax(0,1fr) 106px; min-height:160px;}
        .dispatch-hero-copy {min-width:0;}
        .dispatch-kicker {font-size:.49rem; letter-spacing:.08em;}
        .dispatch-version-badge {font-size:.52rem;}
        .dispatch-hero h1 {font-size:1.42rem;}
        .dispatch-hero p {max-width:240px;}
        .dispatch-hero-art {min-height:134px;}
        .dispatch-hero-art svg {min-height:134px; transform:scale(1.55); transform-origin:center;}
        .hero-art-label span {display:none;}
    }
    /* v27.3 手機操作層：保持可讀，並讓主要控制至少接近 48px 觸控高度。 */
    @media (max-width: 700px) {
        html {font-size: 16px; -webkit-text-size-adjust: 100%;}
        body {overscroll-behavior-y: none;}
        .block-container {
            padding: .48rem .52rem calc(7rem + env(safe-area-inset-bottom, 0px));
        }
        [data-testid="stSidebar"] {
        ...
        .stApp h1 {font-size: 1.55rem; line-height: 1.18;}
        .stApp h2 {font-size: 1.32rem; line-height: 1.22;}
        .stApp h3 {font-size: 1.15rem; line-height: 1.25;}
        .stApp p, .stApp label {line-height: 1.5;}
        .stButton > button,
        ...
        .dispatch-kicker {font-size: .5rem; letter-spacing: .07em;}
        .dispatch-version-badge {min-height: 21px; font-size: .5rem;}
        .dispatch-hero h1 {font-size: 1.34rem; line-height: 1.05;}
        .dispatch-hero p {display: none;}
        .dispatch-hero-tags {margin-top: .48rem; gap: .22rem;}
        .dispatch-hero-tags span {padding: .22rem .3rem; font-size: .46rem;}
        .dispatch-hero-art {min-height: 122px; border-radius: 12px 3px 12px 3px;}
        .dispatch-hero-art svg {min-height: 122px; transform: scale(1.42); transform-origin: center;}
        .dispatch-context-strip {gap: .28rem; padding: .42rem;}
        .dispatch-context-strip span {
            min-height: 32px;
            display: inline-flex;
            align-items: center;
        ...
        .region-fleet-overview {padding: .65rem;}
        .region-fleet-grid {gap: .42rem;}
        .fleet-summary-card {margin: .52rem 0;}
        .analysis-result-table-wrap {
            max-width: 100%;
            overflow-x: auto;
            -webkit-overflow-scrolling: touch;
        ...
        [data-testid="stMetric"] {min-height: 86px; padding: .58rem .62rem;}
        [data-testid="stMetricValue"] {font-size: 1.45rem;}
    }
    @media (max-width: 400px) {
        .block-container {padding-left: .38rem; padding-right: .38rem;}
        .dispatch-hero {grid-template-columns: minmax(0,1fr) 94px; min-height: 138px;}
        .dispatch-hero h1 {font-size: 1.22rem;}
        .dispatch-hero-art, .dispatch-hero-art svg {min-height: 112px;}
        .dispatch-hero-tags span:last-child {display:none;}
        .dispatch-context-strip span {font-size: .68rem;}
    }
    /* 9:16 直式主版面：不做黑邊畫框，直接使用整個手機可視高度。 */
    @media (max-width: 700px) and (orientation: portrait) {
        ...
        .dispatch-hero-art svg {
            width: 100%;
            height: 100%;
            min-height: 0;
            transform: scale(1.36) translateX(6%);
        }
        .dispatch-hero-tags {max-width: 245px;}
        .dispatch-context-strip {
            display: grid;
        ...
        .dispatch-context-strip .dispatch-live-time {grid-column: 1 / -1;}
        [data-testid="stVerticalBlockBorderWrapper"] {width: 100%;}
        .region-fleet-overview,
        .fleet-summary-card,
        .analysis-result-table-wrap {width: 100%; max-width: 100%;}
    }
    @media (max-width: 480px) and (max-aspect-ratio: 9/16) {
        .block-container {
            max-width: none;
            padding-top: max(.38rem, env(safe-area-inset-top, 0px));
        }
        .dispatch-hero {min-height: 148px;}
        .dispatch-hero-copy {width: 76%;}
        .dispatch-hero-art {right: .22rem; width: 46%; opacity: .7;}
        .dispatch-hero h1 {font-size: clamp(1.2rem, 6vw, 1.42rem);}
        .dispatch-hero-tags {max-width: 210px;}
        .dispatch-context-strip span {min-height: 36px;}
        .region-fleet-grid {grid-template-columns: 1fr;}
        .analysis-result-table {width: 100%; table-layout: fixed;}
        .analysis-result-table th,
        .analysis-result-table td {overflow-wrap: anywhere;}
    }
    @media (max-width: 380px) and (max-height: 680px) and (orientation: portrait) {
        .dispatch-hero {min-height: 136px;}
        .dispatch-kicker {display: none;}
        .dispatch-version-badge {margin-top: 0;}
        .dispatch-hero-tags {margin-top: .35rem;}
        .dispatch-context-strip span {min-height: 32px;}
        .block-container {padding-bottom: calc(6.5rem + env(safe-area-inset-bottom, 0px));}
    }
    @media (prefers-reduced-motion: reduce) {
        .dispatch-pulse-dot, .hero-orbit, .hero-energy-road, .hero-core {animation:none !important;}
...
def _build_floating_battery_query_html(
    ...
    (() => {
      ...
      style.textContent = `
        ...
        /* v27.3 — original neon dispatch visual system */
        #ubike-battery-fab {
          width: 68px;
          height: 68px;
          border: 1px solid rgba(118, 252, 255, .72);
          border-radius: 18px 4px 18px 4px;
          clip-path: polygon(0 0, 78% 0, 100% 22%, 100% 100%, 22% 100%, 0 78%);
          color: #071115;
          background:
            linear-gradient(135deg, rgba(255,255,255,.62), transparent 28%),
            linear-gradient(135deg, #7dfff6 0 48%, #f4ff4e 49% 100%);
          box-shadow:
            0 0 0 2px rgba(255, 48, 211, .24),
            0 0 28px rgba(0, 245, 255, .55),
            0 16px 38px rgba(0, 0, 0, .48);
          font: 950 13px/1 -apple-system, BlinkMacSystemFont, "Segoe UI", "Microsoft JhengHei", sans-serif;
          letter-spacing: -.03em;
          transition: transform .2s ease, filter .2s ease, box-shadow .2s ease;
          animation: batteryFabPulse 2.8s ease-in-out infinite;
        }
        #ubike-battery-fab::after {
          content: "LIVE";
          position: absolute;
          right: 4px;
          top: 5px;
          ...
          font-size: 7px;
          letter-spacing: .08em;
          box-shadow: 0 0 9px rgba(255, 32, 201, .8);
        }
        #ubike-battery-fab:hover {
          transform: translateY(-4px) rotate(-1deg) scale(1.04);
          filter: saturate(1.18) brightness(1.08);
          box-shadow: 0 0 34px rgba(0, 245, 255, .75), 0 18px 42px rgba(0, 0, 0, .55);
        }
        #ubike-battery-page {
          isolation: isolate;
          color-scheme: dark;
          color: #e9fdff;
          background:
            radial-gradient(circle at 12% 8%, rgba(255, 25, 190, .20), transparent 28%),
            radial-gradient(circle at 88% 16%, rgba(0, 242, 255, .18), transparent 31%),
            radial-gradient(circle at 52% 95%, rgba(115, 255, 71, .10), transparent 33%),
            linear-gradient(145deg, #03060d 0%, #07131c 48%, #100717 100%);
        }
        #ubike-battery-page::before {
          content: "";
          position: fixed;
          inset: 0;
          z-index: 0;
          pointer-events: none;
          background-image:
            linear-gradient(rgba(60, 246, 255, .045) 1px, transparent 1px),
            linear-gradient(90deg, rgba(60, 246, 255, .045) 1px, transparent 1px),
            repeating-linear-gradient(115deg, transparent 0 120px, rgba(255, 36, 190, .025) 121px 122px);
          background-size: 42px 42px, 42px 42px, 180px 180px;
          mask-image: linear-gradient(to bottom, rgba(0,0,0,.92), transparent 86%);
        }
        #ubike-battery-page::after {
          content: "";
          position: fixed;
          inset: 0;
          z-index: 2;
          pointer-events: none;
          opacity: .24;
          background: repeating-linear-gradient(to bottom, transparent 0 5px, rgba(255,255,255,.04) 6px, transparent 7px);
          animation: batteryScanlines 10s linear infinite;
        }
        #ubike-battery-page .battery-header {
          z-index: 30;
          min-height: 74px;
          ...
          border: 0;
          border-bottom: 1px solid rgba(87, 246, 255, .45);
          color: #f4ffff;
          background:
            linear-gradient(90deg, rgba(4, 9, 17, .96), rgba(10, 23, 31, .91) 55%, rgba(26, 5, 27, .94));
          box-shadow: 0 8px 28px rgba(0,0,0,.42), inset 0 -1px rgba(255, 34, 200, .38);
          backdrop-filter: blur(18px) saturate(1.35);
        }
        #ubike-battery-page .battery-header::after {
          content: "GRID ONLINE  •  27.0";
          margin-left: auto;
          padding: 7px 10px;
          border: 1px solid rgba(244, 255, 78, .62);
          clip-path: polygon(8px 0, 100% 0, 100% calc(100% - 8px), calc(100% - 8px) 100%, 0 100%, 0 8px);
          color: #f4ff4e;
          background: rgba(244, 255, 78, .07);
          box-shadow: inset 0 0 14px rgba(244,255,78,.08), 0 0 13px rgba(244,255,78,.12);
          font-size: 10px;
          font-weight: 950;
          letter-spacing: .16em;
        }
        #ubike-battery-page .battery-back {
          ...
          height: 46px;
          flex-basis: 46px;
          border: 1px solid rgba(74, 250, 255, .72);
          border-radius: 12px 3px 12px 3px;
          color: #76fcff;
          background: linear-gradient(145deg, rgba(0,245,255,.12), rgba(255,31,197,.08));
          box-shadow: inset 0 0 18px rgba(0,245,255,.08), 0 0 17px rgba(0,245,255,.14);
          transition: transform .18s ease, color .18s ease, background .18s ease;
        }
        #ubike-battery-page .battery-back:hover {
          transform: translateX(-3px);
          color: #071015;
          background: #76fcff;
        }
        #ubike-battery-page .battery-title {
          display: flex;
          flex-direction: column;
          gap: 2px;
          font-size: 19px;
          ...
          font-weight: 950;
          letter-spacing: .03em;
          text-shadow: 0 0 18px rgba(89,247,255,.35);
        }
        #ubike-battery-page .battery-title small {
          color: #ff46cd;
          font-size: 9px;
          font-weight: 900;
          letter-spacing: .22em;
        ...
        #ubike-battery-page .battery-main {
          ...
          padding: 22px 20px calc(50px + env(safe-area-inset-bottom, 0px));
        }
        #ubike-battery-page .battery-cyber-hero {
          position: relative;
          display: grid;
          ...
          margin-bottom: 18px;
          overflow: hidden;
          border: 1px solid rgba(92, 246, 255, .56);
          clip-path: polygon(0 0, calc(100% - 42px) 0, 100% 42px, 100% 100%, 42px 100%, 0 calc(100% - 42px));
          background:
            linear-gradient(105deg, rgba(3,10,18,.98) 0 49%, rgba(9,25,32,.91) 50% 68%, rgba(37,3,31,.92) 100%);
          box-shadow: 0 20px 50px rgba(0,0,0,.42), inset 0 0 60px rgba(0,239,255,.035);
        }
        #ubike-battery-page .battery-cyber-hero::before {
          content: "";
          position: absolute;
          top: 0;
          bottom: 0;
          ...
          background: linear-gradient(90deg, transparent, rgba(123,255,255,.18), transparent);
          animation: batteryHeroSweep 5.4s ease-in-out infinite;
        }
        #ubike-battery-page .battery-cyber-hero::after {
          content: "ENERGY LINK // ACTIVE";
          position: absolute;
          right: 18px;
          bottom: 11px;
          z-index: 5;
          color: rgba(160, 255, 255, .62);
          font: 850 9px/1 monospace;
          letter-spacing: .16em;
        }
        #ubike-battery-page .battery-hero-copy {
          position: relative;
          z-index: 3;
          align-self: center;
          padding: 38px 14px 38px 42px;
        }
        #ubike-battery-page .battery-hero-kicker {
          display: inline-flex;
          align-items: center;
          gap: 8px;
          color: #76fcff;
        ...
        #ubike-battery-page .battery-hero-kicker i {
          width: 32px;
          height: 2px;
          background: #ff2bc7;
          box-shadow: 0 0 12px #ff2bc7;
        }
        #ubike-battery-page .battery-hero-copy h1 {
          margin: 11px 0 8px;
          color: #f6ffff;
          ...
          text-shadow: 4px 4px 0 rgba(255, 31, 197, .65), -2px -2px 0 rgba(0, 240, 255, .45);
        }
        #ubike-battery-page .battery-hero-copy h1 span {
          display: block;
          color: #f4ff4e;
          font-size: .7em;
          letter-spacing: .07em;
          text-shadow: 0 0 22px rgba(244,255,78,.34), 3px 3px 0 rgba(255,31,197,.52);
        }
        #ubike-battery-page .battery-hero-copy p {
          max-width: 510px;
          margin: 12px 0 17px;
          color: #b9d7dc;
          font-size: 14px;
        ...
        #ubike-battery-page .battery-hero-chips {
          display: flex;
          flex-wrap: wrap;
          gap: 7px;
        }
        #ubike-battery-page .battery-hero-chip {
          padding: 7px 9px;
        ...
        #ubike-battery-page .battery-hero-chip.hot {
          border-color: rgba(255,50,198,.55);
          color: #ff8edf;
          background: rgba(255,32,197,.08);
        }
        #ubike-battery-page .battery-hero-art {
          position: relative;
          z-index: 2;
          min-height: 300px;
          overflow: hidden;
        }
        #ubike-battery-page .battery-hero-art svg {
          width: 100%;
          height: 100%;
          min-height: 300px;
          display: block;
        ...
        #ubike-battery-page .battery-core {
          transform-origin: 393px 156px;
          animation: batteryCoreFloat 3.4s ease-in-out infinite;
        }
        #ubike-battery-page .battery-orbit {
          transform-origin: 393px 156px;
          animation: batteryOrbitSpin 12s linear infinite;
        }
        #ubike-battery-page .battery-route-spark {
          stroke-dasharray: 4 18;
          animation: batteryRouteFlow 2.1s linear infinite;
        }
        #ubike-battery-page .battery-control-card {
          position: relative;
          padding: 20px;
          border: 1px solid rgba(83, 241, 255, .38);
          border-radius: 4px 20px 4px 20px;
          color: #e9fdff;
          background:
            linear-gradient(135deg, rgba(9, 24, 33, .94), rgba(14, 9, 25, .96)),
            rgba(5, 14, 22, .94);
          box-shadow: 0 16px 40px rgba(0,0,0,.36), inset 4px 0 rgba(255,38,194,.72), inset -1px 0 rgba(103,250,255,.32);
          backdrop-filter: blur(16px);
        }
        #ubike-battery-page .battery-control-card::before {
          ...
          color: #061017;
          background: #76fcff;
          font: 950 9px/1.2 monospace;
          letter-spacing: .13em;
          box-shadow: 0 0 15px rgba(118,252,255,.36);
        }
        #ubike-battery-page .battery-control-grid {
          grid-template-columns: minmax(145px, .65fr) minmax(230px, 1.12fr) minmax(245px, 1fr) minmax(145px, .62fr);
          gap: 15px;
        }
        #ubike-battery-page .battery-label {
          color: #8eeef4;
        ...
        #ubike-battery-page .battery-sort,
        #ubike-battery-page .battery-priority-threshold {
          border: 1px solid rgba(92, 243, 255, .48);
          border-radius: 3px 12px 3px 12px;
          color: #f2feff;
          background: rgba(1, 9, 16, .82);
          box-shadow: inset 0 0 18px rgba(0,226,255,.05), 0 0 0 1px rgba(0,0,0,.3);
          outline: none;
          transition: border-color .18s ease, box-shadow .18s ease, transform .18s ease;
        }
        #ubike-battery-page .battery-threshold:focus,
        #ubike-battery-page .battery-sort:focus,
        #ubike-battery-page .battery-priority-threshold:focus {
          border-color: #f4ff4e;
          box-shadow: 0 0 0 3px rgba(244,255,78,.12), 0 0 21px rgba(0,239,255,.14);
          transform: translateY(-1px);
        }
        #ubike-battery-page .battery-sort option { color: #eaffff; background: #07121c; }
        #ubike-battery-page .battery-threshold-wrap strong,
        #ubike-battery-page .battery-priority-threshold-wrap strong { color: #f4ff4e; }
        #ubike-battery-page .battery-scope {
          border: 1px solid rgba(96, 231, 240, .38);
          border-radius: 3px 12px 3px 12px;
          color: #a8cbd0;
          background: rgba(1, 10, 18, .72);
          box-shadow: inset 0 0 14px rgba(0,239,255,.03);
          transition: transform .18s ease, border-color .18s ease, color .18s ease, background .18s ease;
        }
        #ubike-battery-page .battery-scope:hover {
          transform: translateY(-2px);
          border-color: #77faff;
          color: #f5ffff;
        }
        #ubike-battery-page .battery-scope.selected {
          border-color: #f4ff4e;
          color: #081014;
          background: linear-gradient(135deg, #f4ff4e, #72fff4);
          box-shadow: 0 0 18px rgba(244,255,78,.23);
        }
        #ubike-battery-page .battery-locate {
          border: 1px solid rgba(255,45,200,.58);
          border-radius: 11px 3px 11px 3px;
          color: #ff8bdf;
          background: rgba(255,31,197,.08);
          box-shadow: inset 0 0 14px rgba(255,31,197,.04);
        }
        #ubike-battery-page .battery-locate:hover:not(:disabled) {
          color: #fff;
          background: rgba(255,31,197,.2);
          box-shadow: 0 0 18px rgba(255,31,197,.18);
        }
        #ubike-battery-page .battery-refresh {
          position: relative;
          border: 0;
          ...
          color: #071116;
          background: linear-gradient(105deg, #76fcff 0 63%, #f4ff4e 64% 100%);
          box-shadow: 0 0 26px rgba(0,239,255,.25), inset 0 -3px rgba(0,0,0,.16);
          letter-spacing: .04em;
          transition: transform .18s ease, box-shadow .18s ease, filter .18s ease;
        }
        #ubike-battery-page .battery-refresh:hover:not(:disabled) {
          transform: translateY(-3px);
          filter: brightness(1.07) saturate(1.15);
          box-shadow: 0 0 36px rgba(0,239,255,.4), 0 12px 24px rgba(0,0,0,.28);
        }
        #ubike-battery-page .battery-refresh:disabled { color: #597074; background: #17272c; }
        #ubike-battery-page .battery-inclusive {
          color: #819da2;
          font-family: ui-monospace, SFMono-Regular, Menlo, monospace;
        }
        #ubike-battery-page .battery-inclusive::before { content: "> "; color: #ff36c9; }
        #ubike-battery-page .battery-priority-control {
          border: 1px solid rgba(255, 67, 197, .35);
          border-radius: 14px 3px 14px 3px;
          background: linear-gradient(105deg, rgba(35,8,31,.75), rgba(8,15,24,.9));
          box-shadow: inset 3px 0 rgba(255,43,199,.48);
        }
        #ubike-battery-page .battery-priority-control.enabled {
          border-color: #ff3acb;
          background: linear-gradient(105deg, rgba(84, 4, 55, .75), rgba(29, 4, 17, .94));
          box-shadow: inset 4px 0 #ff2fc7, 0 0 25px rgba(255, 40, 195, .19);
          animation: batteryPriorityPulse 2.8s ease-in-out infinite;
        }
        #ubike-battery-page .battery-priority-toggle { color: #ff91df; }
        #ubike-battery-page .battery-priority-toggle input {
          accent-color: #ff2bc7;
          filter: drop-shadow(0 0 5px rgba(255,43,199,.7));
        }
        #ubike-battery-page .battery-priority-threshold { color: #ffb5e9; }
        #ubike-battery-page .battery-priority-threshold:disabled {
          border-color: rgba(115,140,145,.28);
          color: #5f7379;
          background: rgba(8,15,22,.82);
        }
        #ubike-battery-page .battery-priority-hint { color: #d7a6c8; }
        #ubike-battery-page .battery-location-status { color: #8cf9bd; }
        #ubike-battery-page .battery-location-status.error,
        #ubike-battery-page .battery-status.error { color: #ff6e8f; text-shadow: 0 0 12px rgba(255,44,112,.22); }
        #ubike-battery-page .battery-status {
          margin: 15px 3px 8px;
          color: #9bbdc2;
          font-family: ui-monospace, SFMono-Regular, Menlo, monospace;
        ...
        #ubike-battery-page .battery-status::before { content: "SYS // "; color: #76fcff; font-weight: 900; }
        #ubike-battery-page .battery-summary { gap: 12px; margin: 12px 0 18px; }
        #ubike-battery-page .battery-metric {
          position: relative;
          overflow: hidden;
          padding: 15px;
          border: 1px solid rgba(89, 241, 250, .28);
          border-radius: 3px 14px 3px 14px;
          color: #f4ffff;
          background: linear-gradient(135deg, rgba(10,26,34,.92), rgba(9,10,20,.94));
          box-shadow: inset 3px 0 rgba(82,246,255,.65), 0 9px 24px rgba(0,0,0,.22);
        }
        #ubike-battery-page .battery-metric::after {
          content: "";
          position: absolute;
          width: 38px;
          height: 4px;
          right: 8px;
          top: 8px;
          background: repeating-linear-gradient(90deg, #76fcff 0 5px, transparent 5px 8px);
          opacity: .55;
        }
        #ubike-battery-page .battery-metric.total {
          border-color: rgba(244,255,78,.48);
          background: linear-gradient(135deg, rgba(35,42,11,.82), rgba(8,21,25,.94));
          box-shadow: inset 4px 0 #f4ff4e, 0 0 22px rgba(244,255,78,.08);
        }
        #ubike-battery-page .battery-metric.priority {
          border: 1px solid #ff3aca;
          background: linear-gradient(135deg, rgba(77,4,51,.86), rgba(24,5,20,.96));
          box-shadow: inset 4px 0 #ff2bc7, 0 0 25px rgba(255,38,195,.18);
        }
        #ubike-battery-page .battery-metric-label { color: #85bfc6; letter-spacing: .05em; }
        #ubike-battery-page .battery-metric-value { color: #f8ffff; text-shadow: 0 0 18px rgba(109,247,255,.16); }
        #ubike-battery-page .battery-metric.priority .battery-metric-label,
        #ubike-battery-page .battery-metric.priority .battery-metric-value { color: #ff8edc; }
        #ubike-battery-page .battery-district-summary {
          position: relative;
          overflow: hidden;
          padding: 24px;
          ...
          background:
            linear-gradient(118deg, rgba(79, 3, 52, .94), rgba(20, 7, 27, .97) 54%, rgba(5, 31, 37, .94));
          box-shadow: inset 5px 0 #ff2bc7, inset -1px 0 #76fcff, 0 0 42px rgba(255,38,194,.18), 0 22px 46px rgba(0,0,0,.36);
        }
        #ubike-battery-page .battery-district-summary::before {
          content: "DISTRICT LOAD";
          position: absolute;
          top: 11px;
          right: 14px;
          color: rgba(244,255,78,.72);
          font: 950 9px/1 monospace;
          letter-spacing: .17em;
        }
        #ubike-battery-page .battery-district-summary::after {
          content: "";
          position: absolute;
          right: -45px;
          bottom: -75px;
          width: 190px;
          height: 190px;
          border: 1px solid rgba(118,252,255,.15);
          border-radius: 50%;
          box-shadow: 0 0 0 26px rgba(118,252,255,.025), 0 0 0 54px rgba(255,43,199,.025);
          pointer-events: none;
        }
        #ubike-battery-page .battery-district-summary-title {
          color: #fff;
          font-size: 25px;
          letter-spacing: -.02em;
          text-shadow: 0 0 18px rgba(255,43,199,.28);
        }
        #ubike-battery-page .battery-district-summary-hint { color: #f2abd9; }
        #ubike-battery-page .battery-district-summary-grid { position: relative; z-index: 1; }
        #ubike-battery-page .battery-district-summary .battery-district-metric {
          padding: 19px 12px;
          border: 1px solid rgba(255, 135, 219, .5);
          border-radius: 3px 14px 3px 14px;
          color: #fff;
          background: linear-gradient(145deg, rgba(45,8,37,.94), rgba(5,20,27,.94));
          box-shadow: inset 0 0 20px rgba(255,39,194,.04), 0 10px 20px rgba(0,0,0,.25);
          transition: transform .18s ease, border-color .18s ease, box-shadow .18s ease;
        }
        #ubike-battery-page .battery-district-summary .battery-district-metric:hover {
          transform: translateY(-4px);
          border-color: #f4ff4e;
          box-shadow: 0 0 24px rgba(244,255,78,.12), 0 14px 24px rgba(0,0,0,.3);
        }
        #ubike-battery-page .battery-district-summary .battery-district-metric.highest {
          border-color: #f4ff4e;
          background: linear-gradient(145deg, rgba(68,34,7,.96), rgba(41,6,35,.96));
          box-shadow: inset 4px 0 #f4ff4e, 0 0 28px rgba(244,255,78,.16);
        }
        #ubike-battery-page .battery-district-summary .battery-metric-label {
          color: #ff9ae1;
          font-size: 18px;
        ...
        #ubike-battery-page .battery-district-summary .battery-metric-value {
          color: #f4ff4e;
          font-size: 44px;
          text-shadow: 0 0 20px rgba(244,255,78,.3), 3px 3px 0 rgba(255,33,197,.22);
        }
        #ubike-battery-page .battery-route-title {
          position: relative;
          margin: 24px 2px 11px;
          padding: 10px 12px 10px 16px;
          border-left: 4px solid #76fcff;
          color: #f3ffff;
          background: linear-gradient(90deg, rgba(0,235,255,.11), transparent 72%);
          font-size: 18px;
          letter-spacing: .01em;
          text-shadow: 0 0 16px rgba(118,252,255,.2);
        }
        #ubike-battery-page .battery-station {
          margin-bottom: 11px;
          border: 1px solid rgba(90, 225, 235, .27);
          border-radius: 3px 16px 3px 16px;
          color: #eefdff;
          background: linear-gradient(135deg, rgba(9,23,31,.94), rgba(10,7,18,.96));
          box-shadow: 0 9px 23px rgba(0,0,0,.2), inset 3px 0 rgba(92,240,250,.28);
          transition: transform .18s ease, border-color .18s ease, box-shadow .18s ease;
        }
        #ubike-battery-page .battery-station:hover {
          transform: translateX(3px);
          border-color: rgba(118,252,255,.68);
          box-shadow: 0 0 25px rgba(0,230,255,.09), 0 12px 28px rgba(0,0,0,.28), inset 4px 0 #76fcff;
        }
        #ubike-battery-page .battery-station.unmatched { border-color: rgba(244,255,78,.6); }
        #ubike-battery-page .battery-station.priority {
          border: 1px solid #ff3acb;
          background: linear-gradient(135deg, rgba(73,5,50,.91), rgba(17,5,19,.98));
          box-shadow: inset 5px 0 #ff2bc7, 0 0 27px rgba(255,39,193,.16), 0 12px 28px rgba(0,0,0,.3);
        }
        #ubike-battery-page .battery-station summary { min-height: 62px; padding: 12px 15px; }
        #ubike-battery-page .battery-station[open] summary { border-bottom: 1px solid rgba(95,231,240,.18); }
        #ubike-battery-page .battery-station-name { color: #f4ffff; font-size: 16px; }
        #ubike-battery-page .battery-station-meta { color: #83aeb4; }
        #ubike-battery-page .battery-recommended {
          border: 1px solid rgba(118,252,255,.44);
          color: #8efcff;
          background: rgba(0,236,255,.09);
          box-shadow: 0 0 10px rgba(0,236,255,.06);
        }
        #ubike-battery-page .battery-priority-badge {
          color: #fff;
          background: linear-gradient(90deg, #ff2bc7, #ff315e);
          box-shadow: 0 0 14px rgba(255,43,199,.38);
        }
        #ubike-battery-page .battery-count {
          border: 1px solid rgba(118,252,255,.35);
          color: #86fbff;
          background: rgba(0,236,255,.08);
        }
        #ubike-battery-page .battery-count.needs-change {
          border-color: rgba(255,55,199,.54);
          color: #ff90df;
          background: rgba(255,38,194,.11);
          box-shadow: 0 0 14px rgba(255,38,194,.1);
        }
        #ubike-battery-page .battery-count.unknown { color: #f4ff4e; background: rgba(244,255,78,.08); }
        #ubike-battery-page .battery-bike-list { border-top-color: rgba(93,222,232,.16); }
        #ubike-battery-page .battery-bike-row {
          border-bottom-color: rgba(93,222,232,.1);
          color: #bdd8dc;
          background: rgba(0,0,0,.13);
        }
        #ubike-battery-page .battery-bike-row:nth-child(even) { background: rgba(0,231,255,.025); }
        #ubike-battery-page .battery-bike-row.priority {
          color: #ffe9f8;
          background: linear-gradient(90deg, rgba(255,36,192,.18), rgba(255,39,92,.05));
          box-shadow: inset 4px 0 #ff2bc7;
        }
        #ubike-battery-page .battery-bike-no { color: #eaffff; }
        #ubike-battery-page .battery-power { color: #ff6fd5; text-shadow: 0 0 10px rgba(255,44,194,.19); }
        #ubike-battery-page .battery-empty { color: #789aa0; }
        #ubike-battery-page::-webkit-scrollbar { width: 10px; }
        #ubike-battery-page::-webkit-scrollbar-track { background: #020810; }
        #ubike-battery-page::-webkit-scrollbar-thumb {
          border: 2px solid #020810;
          border-radius: 99px;
          background: linear-gradient(#76fcff, #ff2bc7);
        }
        @keyframes batteryFabPulse {
          0%, 100% { box-shadow: 0 0 0 2px rgba(255,48,211,.24), 0 0 24px rgba(0,245,255,.46), 0 16px 38px rgba(0,0,0,.48); }
          50% { box-shadow: 0 0 0 3px rgba(255,48,211,.35), 0 0 36px rgba(0,245,255,.72), 0 16px 38px rgba(0,0,0,.48); }
        }
        @keyframes batteryScanlines { to { background-position: 0 70px; } }
        @keyframes batteryHeroSweep {
          0%, 12% { left: -20%; opacity: 0; }
          35%, 62% { opacity: 1; }
          88%, 100% { left: 118%; opacity: 0; }
        }
        @keyframes batteryCoreFloat {
          0%, 100% { transform: translateY(0) rotate(-2deg); }
          50% { transform: translateY(-9px) rotate(1deg); }
        }
        @keyframes batteryOrbitSpin { to { transform: rotate(360deg); } }
        @keyframes batteryRouteFlow { to { stroke-dashoffset: -44; } }
        @keyframes batteryPriorityPulse {
          0%, 100% { box-shadow: inset 4px 0 #ff2fc7, 0 0 18px rgba(255,40,195,.12); }
          50% { box-shadow: inset 4px 0 #ff2fc7, 0 0 31px rgba(255,40,195,.26); }
        }
        @media (max-width: 820px) {
          #ubike-battery-page .battery-header::after { display: none; }
          #ubike-battery-page .battery-main { padding-top: 12px; }
          #ubike-battery-page .battery-cyber-hero {
            grid-template-columns: 1fr;
            min-height: auto;
            clip-path: polygon(0 0, calc(100% - 28px) 0, 100% 28px, 100% 100%, 28px 100%, 0 calc(100% - 28px));
          }
          #ubike-battery-page .battery-hero-copy { padding: 31px 24px 10px; }
          #ubike-battery-page .battery-hero-copy h1 { font-size: clamp(43px, 13vw, 68px); }
          #ubike-battery-page .battery-hero-art { min-height: 215px; }
          #ubike-battery-page .battery-hero-art svg { min-height: 215px; }
        }
        @media (max-width: 700px) {
          #ubike-battery-fab {
            right: 12px;
          ...
          #ubike-battery-page .battery-header { min-height: 64px; padding-left: 9px; padding-right: 9px; }
          #ubike-battery-page .battery-back { width: 44px; height: 44px; flex-basis: 44px; }
          #ubike-battery-page .battery-title { font-size: 15px; }
          #ubike-battery-page .battery-title small { font-size: 8px; letter-spacing: .16em; }
          #ubike-battery-page .battery-main { padding: 9px 8px calc(28px + env(safe-area-inset-bottom, 0px)); }
          #ubike-battery-page .battery-cyber-hero {
            display: block;
            min-height: 176px;
            margin-bottom: 14px;
          ...
          #ubike-battery-page .battery-hero-copy {
            position: relative;
            z-index: 4;
            padding: 23px 34% 18px 17px;
          }
          #ubike-battery-page .battery-hero-kicker { font-size: 8px; letter-spacing: .09em; }
          #ubike-battery-page .battery-hero-kicker i { width: 20px; }
          #ubike-battery-page .battery-hero-copy h1 {
            margin-top: 9px;
            font-size: clamp(35px, 10.5vw, 46px);
            line-height: .88;
          }
          #ubike-battery-page .battery-hero-copy p { display: none; }
          #ubike-battery-page .battery-hero-chips { gap: 4px; margin-top: 13px; }
          #ubike-battery-page .battery-hero-chip { padding: 5px 6px; font-size: 8px; }
          #ubike-battery-page .battery-hero-art {
            position: absolute;
            top: 0;
            right: 0;
          ...
          #ubike-battery-page .battery-cyber-hero::after { right: 11px; bottom: 8px; font-size: 7px; }
          #ubike-battery-page .battery-control-card { padding: 18px 12px 14px; }
          #ubike-battery-page .battery-control-grid { gap: 10px; }
          #ubike-battery-page .battery-label { margin-bottom: 6px; font-size: 12px; }
          #ubike-battery-page .battery-threshold,
          #ubike-battery-page .battery-sort,
          #ubike-battery-page .battery-priority-threshold {
            min-height: 50px;
          ...
          #ubike-battery-page .battery-locate { min-height: 48px; touch-action: manipulation; }
          #ubike-battery-page .battery-refresh { min-height: 52px; touch-action: manipulation; }
          #ubike-battery-page .battery-inclusive { line-height: 1.45; }
          #ubike-battery-page .battery-priority-control { gap: 9px; padding: 11px; }
          #ubike-battery-page .battery-priority-toggle { min-height: 44px; }
          #ubike-battery-page .battery-priority-threshold { width: 96px; }
          #ubike-battery-page .battery-priority-hint { line-height: 1.55; }
          #ubike-battery-page .battery-summary { gap: 8px; }
          #ubike-battery-page .battery-metric { min-height: 82px; padding: 12px 10px; }
          #ubike-battery-page .battery-metric-value { font-size: 23px; }
          #ubike-battery-page .battery-district-summary { padding: 20px 11px 15px; }
          #ubike-battery-page .battery-district-summary::before { top: 8px; right: 9px; font-size: 7px; }
          #ubike-battery-page .battery-district-summary-title { font-size: 20px; padding-right: 72px; }
          #ubike-battery-page .battery-district-summary .battery-metric-value { font-size: 36px; }
          #ubike-battery-page .battery-district-summary .battery-district-metric { min-height: 104px; padding: 15px 8px; }
          #ubike-battery-page .battery-route-title { margin-top: 18px; font-size: 16px; }
          #ubike-battery-page .battery-station summary { min-height: 62px; padding: 11px; touch-action: manipulation; }
          #ubike-battery-page .battery-station-name { font-size: 15px; line-height: 1.35; }
          #ubike-battery-page .battery-count { padding: 6px 8px; }
          #ubike-battery-page .battery-bike-row { min-height: 48px; align-items: center; font-size: 13px; }
          #ubike-battery-page .battery-station:hover { transform: none; }
        }
        @media (max-width: 400px) {
          #ubike-battery-page .battery-title { font-size: 14px; }
          #ubike-battery-page .battery-cyber-hero { min-height: 162px; }
          #ubike-battery-page .battery-hero-copy { padding-right: 29%; }
          #ubike-battery-page .battery-hero-copy h1 { font-size: 34px; }
          #ubike-battery-page .battery-hero-art { width: 51%; opacity: .68; }
          #ubike-battery-page .battery-hero-chip:last-child { display: none; }
          #ubike-battery-page .battery-summary { grid-template-columns: repeat(2, minmax(0,1fr)); }
          #ubike-battery-page .battery-district-summary-grid { grid-template-columns: repeat(2, minmax(0,1fr)); }
          #ubike-battery-page .battery-bike-row { grid-template-columns: 1.08fr .62fr .86fr; gap: 5px; }
        }
        @media (max-width: 700px) and (orientation: portrait) {
          #ubike-battery-page { min-height: 100vh; min-height: 100dvh; }
          #ubike-battery-page .battery-header {
          ...
          #ubike-battery-page .battery-cyber-hero { width: 100%; }
          #ubike-battery-page .battery-control-card,
          #ubike-battery-page .battery-summary,
          #ubike-battery-page .battery-district-summary,
          #ubike-battery-page .battery-results { width: 100%; max-width: 100%; }
          #ubike-battery-page .battery-summary,
          #ubike-battery-page .battery-district-summary-grid {
            grid-template-columns: repeat(2, minmax(0, 1fr));
          }
        ...
        @media (max-width: 480px) and (max-aspect-ratio: 9/16) {
          #ubike-battery-page .battery-main { max-width: none; }
          #ubike-battery-page .battery-cyber-hero { min-height: 168px; }
          #ubike-battery-page .battery-hero-copy { width: 100%; padding-right: 31%; }
          #ubike-battery-page .battery-hero-art { width: 53%; }
          #ubike-battery-page .battery-control-grid { grid-template-columns: 1fr; }
          #ubike-battery-page .battery-sort-wrap { grid-template-columns: minmax(0, 1fr) auto; }
          #ubike-battery-page .battery-priority-control { grid-template-columns: 1fr; }
          #ubike-battery-page .battery-district-summary-title { line-height: 1.3; }
          #ubike-battery-page .battery-station { width: 100%; }
        }
        @media (max-width: 380px) and (max-height: 680px) and (orientation: portrait) {
          #ubike-battery-fab { width: 56px; height: 56px; font-size: 11px; }
          #ubike-battery-page .battery-cyber-hero { min-height: 150px; }
          #ubike-battery-page .battery-hero-kicker { display: none; }
          #ubike-battery-page .battery-hero-copy { padding-top: 20px; }
          #ubike-battery-page .battery-hero-copy h1 { margin-top: 0; font-size: 32px; }
          #ubike-battery-page .battery-hero-chips { margin-top: 9px; }
          #ubike-battery-page .battery-control-card { padding-top: 16px; }
        }
        @media (prefers-reduced-motion: reduce) {
          #ubike-battery-fab,
          #ubike-battery-page::after,
          ...
          #ubike-battery-page .battery-orbit,
          #ubike-battery-page .battery-route-spark,
          #ubike-battery-page .battery-priority-control.enabled { animation: none !important; }
        }
      `;
      doc.head.appendChild(style);
      ...
      page.innerHTML = `
        <header class="battery-header">
          ...
          <div class="battery-title">
            <span>⚡ 2.0E 電量查詢｜v27.3</span>
            <small>NEON ENERGY COMMAND</small>
          </div>
        </header>
        <main class="battery-main">
          <section class="battery-cyber-hero" aria-label="電量調度系統視覺主題">
            <div class="battery-hero-copy">
              <div class="battery-hero-kicker"><i></i>TAITUNG E-BIKE GRID / LIVE OPS</div>
              <h1>ENERGY <span>SCAN</span></h1>
              <p>掃描低電量車輛、優先鎖定急需更換的場站。零需求場站自動隱藏，讓調度視線只停在真正需要處理的位置。</p>
              <div class="battery-hero-chips">
                <span class="battery-hero-chip">DEFAULT // 89%</span>
                <span class="battery-hero-chip hot">PRIORITY // OPTIONAL</span>
                <span class="battery-hero-chip">ZERO // HIDDEN</span>
              </div>
            </div>
            <div class="battery-hero-art" aria-hidden="true">
              <svg viewBox="0 0 580 330" role="img">
                <defs>
                  <linearGradient id="batterySky27" x1="0" y1="0" x2="1" y2="1">
                    <stop offset="0" stop-color="#06141d"/>
                    <stop offset=".56" stop-color="#0a2530"/>
                    <stop offset="1" stop-color="#310525"/>
                  </linearGradient>
                  <linearGradient id="batteryCore27" x1="0" y1="0" x2="1" y2="1">
                    <stop offset="0" stop-color="#f4ff4e"/>
                    <stop offset=".45" stop-color="#76fcff"/>
                    <stop offset="1" stop-color="#00a9ff"/>
                  </linearGradient>
                  <linearGradient id="batteryPink27" x1="0" y1="0" x2="1" y2="0">
                    <stop offset="0" stop-color="#ff2bc7" stop-opacity="0"/>
                    <stop offset=".4" stop-color="#ff2bc7"/>
                    <stop offset="1" stop-color="#ff315e"/>
                  </linearGradient>
                  <pattern id="batteryGrid27" width="28" height="28" patternUnits="userSpaceOnUse">
                    <path d="M 28 0 L 0 0 0 28" fill="none" stroke="#76fcff" stroke-opacity=".11" stroke-width="1"/>
                  </pattern>
                  <filter id="batteryGlow27" x="-80%" y="-80%" width="260%" height="260%">
                    <feGaussianBlur stdDeviation="5" result="blur"/>
                    <feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge>
                  </filter>
                </defs>
                <rect width="580" height="330" fill="url(#batterySky27)"/>
                <rect width="580" height="330" fill="url(#batteryGrid27)"/>
                <path d="M0 265L44 238 82 250 116 206 155 226 193 184 225 215 258 171 292 204 324 150 356 188 392 121 425 174 458 139 492 188 530 151 580 176V330H0Z" fill="#030910" opacity=".84"/>
                <g opacity=".72">
                  <path d="M36 260V201H69V260M82 260V178H118V260M132 260V216H166V260M184 260V154H222V260M237 260V201H269V260" fill="#07151d" stroke="#52f3f9" stroke-opacity=".31"/>
                  <path d="M45 214H61M45 226H61M91 192H109M91 205H109M193 170H213M193 184H213M246 216H260" stroke="#f4ff4e" stroke-opacity=".55" stroke-width="3"/>
                </g>
                <path d="M8 286C98 245 145 303 219 256S330 244 390 217 493 235 570 180" fill="none" stroke="#092a32" stroke-width="18"/>
                <path d="M8 286C98 245 145 303 219 256S330 244 390 217 493 235 570 180" fill="none" stroke="#76fcff" stroke-opacity=".45" stroke-width="2"/>
                <path class="battery-route-spark" d="M8 286C98 245 145 303 219 256S330 244 390 217 493 235 570 180" fill="none" stroke="#f4ff4e" stroke-width="4" filter="url(#batteryGlow27)"/>
                <g class="battery-orbit" fill="none">
                  <ellipse cx="393" cy="156" rx="112" ry="83" stroke="#76fcff" stroke-opacity=".24" stroke-width="1.5"/>
                  <ellipse cx="393" cy="156" rx="91" ry="112" stroke="#ff2bc7" stroke-opacity=".18" transform="rotate(56 393 156)"/>
                  <circle cx="493" cy="119" r="5" fill="#ff2bc7" stroke="#ff8edf" filter="url(#batteryGlow27)"/>
                  <circle cx="321" cy="218" r="4" fill="#f4ff4e" stroke="#f4ff4e" filter="url(#batteryGlow27)"/>
                </g>
                <g class="battery-core" filter="url(#batteryGlow27)">
                  <path d="M349 72H430L451 93V235L429 257H349L327 235V94Z" fill="#051219" stroke="url(#batteryCore27)" stroke-width="5"/>
                  <path d="M374 57H407L416 72H365Z" fill="#76fcff"/>
                  <path d="M345 207H433V232L423 242H355L345 232Z" fill="url(#batteryCore27)" opacity=".82"/>
                  <path d="M402 103L366 163H389L374 211 423 143H397Z" fill="#f4ff4e" stroke="#fff" stroke-opacity=".48" stroke-width="2"/>
                  <path d="M342 91H375M430 238H402" stroke="#ff2bc7" stroke-width="7"/>
                </g>
                <g font-family="monospace" font-weight="800">
                  <text x="288" y="39" fill="#76fcff" font-size="10" letter-spacing="3">GRID NODE / 27</text>
                  <text x="470" y="66" fill="#ff77dc" font-size="9">100101</text>
                  <text x="455" y="280" fill="#f4ff4e" font-size="10" letter-spacing="2">LINK OK</text>
                </g>
                <path d="M486 16H570V23H506L495 34H454" fill="none" stroke="url(#batteryPink27)" stroke-width="4"/>
                <path d="M22 52H128L145 69H206" fill="none" stroke="#76fcff" stroke-opacity=".45" stroke-width="2"/>
                <circle cx="22" cy="52" r="4" fill="#f4ff4e" filter="url(#batteryGlow27)"/>
              </svg>
            </div>
          </section>
      ...
      async function getCatalog() {
        ...
        catalogCache = extractItems(payload).filter(isTaitungStation);
        if (!catalogCache.length) throw new Error("找不到臺東場站清單");
        return catalogCache;
      }
      ...
      async function getBatteryList(stationNo) {
        const payload = await fetchJson(`${batteryUrl}?station_no=${encodeURIComponent(stationNo)}`);
        ...
        return records.map(record => {
          ...
          return {
            ...
            battery_power: Number.isFinite(batteryPower) ? Math.max(0, Math.min(100, Math.trunc(batteryPower))) : null,
          };
      ...
      async function mapWithConcurrency(items, limit, task) {
        ...
        async function worker() {
          while (nextIndex < items.length) {
            ...
            if (isMobileRequestMode && nextIndex < items.length) {
      ...
      async function runQuery() {
        ...
        try {
          ...
          let completed = 0;
          lastResults = await mapWithConcurrency(
            entries,
            isMobileRequestMode ? 2 : 4,
            async entry => {
              ...
              let bikes = [];
              try { bikes = stationNo ? await getBatteryList(stationNo) : []; }
          ...
          renderResults();
          const unmatchedCount = lastResults.filter(result => !result.matched).length;
          ...
          setStatus(
            `更新時間 ${timeText}｜${lastResults.length - unmatchedCount} 個場站完成`
      ...
      if (displayMode === "mobile" || win.matchMedia("(max-width: 700px)").matches) {
        fab.style.bottom = "calc(10px + env(safe-area-inset-bottom, 0px))";
      }
...
def render_smart_dispatch(
    *,
    ...
    visible_candidates = candidates[:15]
