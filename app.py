...
st.markdown(
    ...
    .stApp::before {
        ...
        pointer-events: none;
        background:
            linear-gradient(rgba(64,246,255,.035) 1px, transparent 1px),
            linear-gradient(90deg, rgba(64,246,255,.035) 1px, transparent 1px);
    ...
    .stApp::after {
        ...
        pointer-events: none;
        opacity: .16;
        background: repeating-linear-gradient(to bottom, transparent 0 4px, rgba(0,0,0,.24) 5px 6px);
    ...
    .block-container {position: relative; z-index: 1; padding-top: 1rem;}
...
def _build_floating_battery_query_html(
    ...
    (() => {
      ...
      style.textContent = `
        ...
        /* v27.0 — original neon dispatch visual system */
        #ubike-battery-fab {
          width: 68px;
          height: 68px;
        ...
        @media (max-width: 700px) {
          ...
          #ubike-battery-page .battery-title { font-size: 16px; }
          #ubike-battery-page .battery-main { padding: 10px 8px calc(32px + env(safe-area-inset-bottom, 0px)); }
          #ubike-battery-page .battery-cyber-hero { margin-bottom: 15px; }
          #ubike-battery-page .battery-hero-copy { padding: 27px 18px 6px; }
          #ubike-battery-page .battery-hero-copy p { font-size: 13px; }
          #ubike-battery-page .battery-hero-art { min-height: 190px; }
          #ubike-battery-page .battery-hero-art svg { min-height: 190px; }
          #ubike-battery-page .battery-control-card { padding: 17px 12px 14px; }
          #ubike-battery-page .battery-scope { flex: 1 1 76px; }
