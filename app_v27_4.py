    ...
    (() => {
      ...
      page.innerHTML = `
        <header class="battery-header">
          ...
          <div class="battery-title">⚡ 2.0E 電量查詢｜v27.4</div>
        </header>
