...
st.markdown(
    ...
    /* v27.2 手機操作層：保持可讀，並讓主要控制至少接近 48px 觸控高度。 */
    @media (max-width: 700px) {
...
def _build_floating_battery_query_html(
    ...
    (() => {
      ...
      style.textContent = `
        ...
        /* v27.2 — original neon dispatch visual system */
        #ubike-battery-fab {
          width: 68px;
          height: 68px;
